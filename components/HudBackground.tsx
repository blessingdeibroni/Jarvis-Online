...
export function HudBackground({ visible = true, intensity = 1 }: HudBackgroundProps) {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      setCoords(
        `${randomInRange(30, 45, 4)}° N, ${randomInRange(110, 125, 4)}° W`
      );
      setDataStream(
    ...
    <AnimatePresence>
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-[6%] left-[22%]">
          <svg
            viewBox="0 0 80 80"
            className="hud-dial-reverse h-16 w-16 text-[#00eaff]/75"
          >
        ...
        <div className="absolute bottom-4 right-4 h-8 w-8 border-r border-b border-[#00eaff]/60" />
      </div>
